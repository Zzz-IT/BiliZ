...
object ModuleSettings {
    const val PREFS_NAME = "biliz_settings"
    ...
    const val KEY_ENABLE_EXP_END_PAGE = "enable_exp_end_page"
    const val KEY_FIX_MEDIA_SESSION_CARD = "fix_media_session_card"
    const val KEY_AUTO_SKIP_NEXT_ON_SERIES_END = "auto_skip_next_on_series_end"
    ...
    const val KEY_MINE_LIST_STYLE = "mine_list_style"
    ...
    const val KEY_RUNTIME_NIGHT_MODE = "runtime_night_mode"
    ...
    val exportableSwitchSpecs = listOf(
        ...
        ExportableConfigSpec(KEY_DISABLE_HALF_END_PAGE, ExportableValueType.BOOLEAN) { it.getBoolean(KEY_DISABLE_HALF_END_PAGE, false) },
        ExportableConfigSpec(KEY_DISABLE_ALL_END_PAGE, ExportableValueType.BOOLEAN) { it.getBoolean(KEY_DISABLE_ALL_END_PAGE, false) },
        ExportableConfigSpec(KEY_ENABLE_EXP_END_PAGE, ExportableValueType.BOOLEAN) { it.getBoolean(KEY_ENABLE_EXP_END_PAGE, false) },
        ExportableConfigSpec(KEY_FIX_MEDIA_SESSION_CARD, ExportableValueType.BOOLEAN) { it.getBoolean(KEY_FIX_MEDIA_SESSION_CARD, true) },
        ExportableConfigSpec(KEY_AUTO_SKIP_NEXT_ON_SERIES_END, ExportableValueType.BOOLEAN) { it.getBoolean(KEY_AUTO_SKIP_NEXT_ON_SERIES_END, true) },
        ...
        ExportableConfigSpec(KEY_MINE_LIST_STYLE, ExportableValueType.BOOLEAN) { it.getBoolean(KEY_MINE_LIST_STYLE, false) },
        ExportableConfigSpec(KEY_FAKE_WIFI_ENABLED, ExportableValueType.BOOLEAN) { it.getBoolean(KEY_FAKE_WIFI_ENABLED, true) },
    ...
    fun isSkipVideoAdSettingsVisible(prefs: SharedPreferences): Boolean =
        prefs.getBoolean(KEY_SKIP_VIDEO_AD_SETTINGS_VISIBLE, true)

    fun isTryFreeQualitySettingsVisible(prefs: SharedPreferences): Boolean =
        prefs.getBoolean(KEY_TRY_FREE_QUALITY_SETTINGS_VISIBLE, true)
    ...
    fun isEnableExpEndPage(prefs: SharedPreferences): Boolean =
        prefs.getBoolean(KEY_ENABLE_EXP_END_PAGE, false)
    ...
    val cdnEndpoints = listOf(
        CdnEndpoint("ali（阿里云）", "upos-sz-mirrorali.bilivideo.com"),
        CdnEndpoint("alib（阿里云）", "upos-sz-mirroralib.bilivideo.com"),
        CdnEndpoint("alio1（阿里云）", "upos-sz-mirroralio1.bilivideo.com"),
        CdnEndpoint("cos（腾讯云）", "upos-sz-mirrorcos.bilivideo.com"),
        CdnEndpoint("cosb（腾讯云，VOD加速类型）", "upos-sz-mirrorcosb.bilivideo.com"),
        CdnEndpoint("coso1（腾讯云）", "upos-sz-mirrorcoso1.bilivideo.com"),
        CdnEndpoint("hw（华为云，融合CDN）", "upos-sz-mirrorhw.bilivideo.com"),
        CdnEndpoint("hwb（华为云，融合CDN）", "upos-sz-mirrorhwb.bilivideo.com"),
        CdnEndpoint("hwo1（华为云，融合CDN）", "upos-sz-mirrorhwo1.bilivideo.com"),
        CdnEndpoint("08c（华为云，融合CDN）", "upos-sz-mirror08c.bilivideo.com"),
        CdnEndpoint("08h（华为云，融合CDN）", "upos-sz-mirror08h.bilivideo.com"),
        CdnEndpoint("08ct（华为云，融合CDN）", "upos-sz-mirror08ct.bilivideo.com"),
        CdnEndpoint("tf_hw（华为云）", "upos-tf-all-hw.bilivideo.com"),
        CdnEndpoint("tf_tx（腾讯云）", "upos-tf-all-tx.bilivideo.com"),
        CdnEndpoint("akamai（Akamai海外）", "upos-hz-mirrorakam.akamaized.net"),
        CdnEndpoint("aliov（阿里云海外）", "upos-sz-mirroraliov.bilivideo.com"),
        CdnEndpoint("cosov（腾讯云海外）", "upos-sz-mirrorcosov.bilivideo.com"),
        CdnEndpoint("hwov（华为云海外）", "upos-sz-mirrorhwov.bilivideo.com"),
        CdnEndpoint("hk_bcache（Bilibili海外）", "cn-hk-eq-bcache-01.bilivideo.com"),
    )
    ...
    fun isMineListStyleEnabled(prefs: SharedPreferences): Boolean =
        prefs.getBoolean(KEY_MINE_LIST_STYLE, false)

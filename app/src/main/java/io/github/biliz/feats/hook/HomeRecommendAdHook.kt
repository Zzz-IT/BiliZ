        ...
        feedSymbols.responseGetItems.forEach { response ->
            ...
            env.hookAfter(getItems) { param ->
                runCatching {
                    ...
                    log("HomeRecommendAd failed on getItems hook", it)
                }
            }
            count += 1
        }
